...
class Host:
    def __init__(self,ip):
        ...
        self.querysock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM, socket.IPPROTO_UDP)
         # # Enable broadcasting mode
        ...
        self.responsesock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM, socket.IPPROTO_UDP)
    ...
    def query(self):
        ...
        while True:
            ...
            if dest_ip not in self.arptable:
                ...
                self.querysock.sendto(pickle.dumps(packet), ('<broadcast>', RESPONSE_PORT))
    ...
    def response(self):
        while True:
            ...
            if destip == self.ip:
                ...
                self.responsesock.sendto(pickle.dumps(packet), (sourceip, QUERY_PORT))
